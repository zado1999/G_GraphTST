...
def main(new_args={}):
    ...
    parser.add_argument("--data_path", type=str, default="solar.csv", help="data file")
    parser.add_argument(
        "--features",
        type=str,
        default="M",
    ...
    parser.add_argument(
        "--target", type=str, default="0", help="target feature in S or MS task"
    )
    parser.add_argument(
        "--freq",
        type=str,
    ...
    parser.add_argument(
        "--graph_depth", type=int, default=3, help="graph aggregation depth"
    )
    ...
    return round(mae, 4), round(mse, 4), round(train_duration, 4)


if __name__ == "__main__":

    for model in ["Transformer", "Autoformer", "GRU", "CNN1D", "DLinear"]:
        main(
            {
