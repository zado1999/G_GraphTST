...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            all_loss.append([train_loss, vali_loss, test_loss])
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(
                ...
                if test_data.scale and self.args.inverse:
                    shape = outputs.shape
                    outputs1 = test_data.inverse_transform(
                        outputs.reshape(shape[0] * shape[1], -1)
                    ).reshape(shape)
                    batch_y1 = test_data.inverse_transform(
                ...
                if self.args.inverse:
                    ...
                    batch_y1 = batch_y1[:, :, f_dim:]
                    preds1.append(outputs1)
                    trues1.append(batch_y1)
                if i % 20 == 0:
        ...
        if self.args.inverse:
            ...
            trues1 = np.concatenate(trues1, axis=0)
        ...
        #     preds2 = preds1[:, :, i]
        #     trues2 = trues1[:, :, i]
        #     mae, mse, rmse, mape, mspe = metric(preds2, trues2)
